...
# CORS Configuration - DO NOT MODIFY THIS STRUCTURE
# - allow_origins MUST be a list[str], never use allowed_origin_regex or dynamic parsing
# - allowed_origins is defined in app/core/config.py only
# - For Vercel monorepo: allowed_origins=['*'] by default (same domain)
# - For localhost: allowed_origins=['*'] (dev server handles cross-origin)
# See app/core/config.py for origin parsing and production overrides via environment
app.add_middleware(
    CORSMiddleware,
